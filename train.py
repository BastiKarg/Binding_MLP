...
parser.add_argument('--num_workers', type=int, default=1) # 58
...
model_input = hparams.val_path.split("/")[2]

def train():
  model_name = 'BindingMLP_' + model_input
...
logger = WandbLogger(project='BindinMLP_' + model_input)
sweep_id = wandb.sweep(
    sweep=sweep_config, 
    project="BindinMLP_" + model_input)
